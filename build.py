...
w('</div>')
w('<div class="notice"><b>Two public holidays fall inside this trip.</b>Mid-Autumn is Fri 25 – Sun 27 September, covering all of Xi\'an and the arrival in Chengdu. National Day Golden Week is Thu 1 – Wed 7 October: 30 September is Martyrs\' Day and the heaviest travel day of the Chinese year, and Chongqing sits in days one and two. Hongyadong, Ciqikou and Liziba will be jammed and security around monuments is heavy — do the crowd-magnets before 09:00 or after 21:00. Mon 28 and Tue 29 September in Chengdu are the only clear days in the second half. <b>Booked and paid:</b> the Mutianyu private car with entrance and shuttle, the cable car up, the toboggan down. <b>Still to book:</b> Chongqing 1949 (National Day will sell it out), the Panda Base, the Temple of Heaven, and from 16 September the Forbidden City at bookingticket.dpm.org.cn and Tiananmen Square via the WeChat mini-program at noon Beijing time. Install Showstart 秀动 and Damai 大麦 for gig tickets, and Amap 高德 for navigation.</div>')
w('</div></header>')
